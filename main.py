...
""" Arguments related to network architecture 网络结构的相关说明"""
...
parser.add_argument('--batch_size', dest='batch_size', type=int, default=1, help='# images in batch')#batch_size没搞懂
...
parser.add_argument('--save_freq', dest='save_freq', type=int, default=100, help='save the model every save_freq sgd iterations')#疑似关键
